<template>
                      ...
                      <div class="nav-outer clearfix">         
                          <nav class="main-menu">
                              <ul class="navigation clearfix">
                                  ...
                                  <li class="current"><router-link to="travelsyncking">TravelSync</router-link></li>
          ...
          <div class="content-box">
              ...
              <div class="bread-crumb">
                  <ul class="clearfix">
                      ...
                      <li class="current">TravelSync</li>
                  </ul>
              </div>
          </div>
      </div>
  ...
  <!--TravelSync Section-->
  <section class="travelsyncking-section">
      <div class="floated-icon left"><img src="@/assets/images/resource/hills-image-2.svg" alt="" title=""></div>
      <div class="floated-icon right"><img src="@/assets/images/resource/stones-right.svg" alt="" title=""></div>
      <div class="floated-icon right-2"><img src="@/assets/images/resource/floated-icon-right-2.svg" alt="" title=""></div>
      <div class="auto-container">
          <div class="title-box centered">
              <h2><span>Best Group Bookings for you with TravelSync</span></h2>
          ...
          <div class="mixitup-gallery">
              ...
              <div class="filter-list row clearfix">
                  <!--Block-->
                  <div class="travelsync-block-one style-two mix all moderate m-difficult col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                  ...
                  <!--Block-->
                  <div class="travelsync-block-one style-two mix all easy-m difficult col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                  ...
                  <!--Block-->
                  <div class="travelsync-block-one style-two mix all m-difficult col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                  ...
                  <!--Block-->
                  <div class="travelsync-block-one style-two mix all easy-m moderate col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/f-image-4.jpg" alt="" title=""></router-link></div>
                              <div class="price"><span>$120</span></div>
                              <div class="info">
                                  <span class="i-block"><i class="icon far fa-clock"></i> 5 days</span> &ensp; | &ensp; <span class="i-block">259P, Himalaya Ag</span>
                              </div>
                          ...
                          <div class="lower-content">
                              <h4><router-link to="/">Best Of Switzerland</router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
                  ...
                  <!--Block-->
                  <div class="travelsync-block-one style-two mix all moderate difficult col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/f-image-5.jpg" alt="" title=""></router-link></div>
                              <div class="price"><span>$120</span></div>
                              <div class="info">
                                  <span class="i-block"><i class="icon far fa-clock"></i> 5 days</span> &ensp; | &ensp; <span class="i-block">259P, Himalaya Ag</span>
                              </div>
                          ...
                          <div class="lower-content">
                              <h4><router-link to="/">Italian Dolomites</router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
                  ...
                  <!--Block-->
                  <div class="travelsync-block-one style-two mix all easy-m moderate m-difficult difficult col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/f-image-3.jpg" alt="" title=""></router-link></div>
                              <div class="price"><span>$120</span></div>
          ...
          <div class="row clearfix">
              ...
              <div class="image-col col-lg-6 col-md-12 col-sm-12">
                  <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                      <div class="image-box">
                          <img src="@/assets/images/resource/faq-image-1.svg" alt="" title="">
                      </div>
                  </div>
              </div>
          </div>
