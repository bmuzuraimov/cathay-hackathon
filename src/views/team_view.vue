<template>
  ...
  <section class="team-section team-page">
      ...
      <div class="floated-icon right"><img src="@/assets/images/resource/stones-right-2.svg" alt="" title=""></div>
      <div class="auto-container">
          <div class="content-box">
              <div class="row clearfix">
                  ...
                  <div class="team-block-one col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/team-1.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-box">
                              <h4><router-link to="/">Andree Hoy</router-link></h4>
                              <div class="designation">Tour Guide</div>
                              <div class="phone">
                                  <router-link to="/" class="theme-btn call-btn"><i class="icon"><img src="@/assets/images/icons/phone-call.svg" alt="" title=""></i></router-link>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="team-block-one col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/team-2.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-box">
                              <h4><router-link to="/">Andree Hoy</router-link></h4>
                              <div class="designation">Tour Guide</div>
                  ...
                  <div class="team-block-one col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/team-3.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-box">
                              <h4><router-link to="/">Andree Hoy</router-link></h4>
                              <div class="designation">Tour Guide</div>
                  ...
                  <div class="team-block-one col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/team-4.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-box">
                              <h4><router-link to="/">Andree Hoy</router-link></h4>
                              <div class="designation">Tour Guide</div>
                  ...
                  <div class="team-block-one col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/team-5.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-box">
                              <h4><router-link to="/">Andree Hoy</router-link></h4>
                              <div class="designation">Tour Guide</div>
                  ...
                  <div class="team-block-one col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/team-6.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-box">
                              <h4><router-link to="/">Andree Hoy</router-link></h4>
                              <div class="designation">Tour Guide</div>
          ...
          <div class="upper-box">
              <div class="row clearfix">
                  ...
                  <div class="feature-block col-lg-3 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="icon-box"><img src="@/assets/images/resource/f-icon-1.svg" alt="" ></div>
                  ...
                  <div class="feature-block col-lg-3 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="icon-box"><img src="@/assets/images/resource/f-icon-2.svg" alt="" ></div>
                  ...
                  <div class="feature-block col-lg-3 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="icon-box"><img src="@/assets/images/resource/f-icon-3.svg" alt="" ></div>
                          <h5>Great Hotel</h5>
                          <div class="text">Richly varied landscapes, luxury accommodation travel Fully.</div>
                      </div>
                  </div>
                  ...
                  <div class="feature-block col-lg-3 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="icon-box"><img src="@/assets/images/resource/f-icon-4.svg" alt="" ></div>
                          <h5>Fast Booking</h5>
                          <div class="text">Richly varied landscapes, luxury accommodation travel Fully.</div>
                      </div>
                  </div>
                      ...
                      <div class="slide-item">
                          <div class="inner">
                              <div class="left-image">
                                  <div class="icon"><img src="@/assets/images/icons/quotes-3.svg" alt=""></div>
                                  <div class="image"><img src="@/assets/images/resource/rev-thumb-4.png" alt=""></div>
                              </div>
