          ...
          <div class="content-box">
              <div class="row clearfix">
                  ...
                  <div class="tour-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/tour-1.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                              <h4><router-link to="/">Amber Palace </router-link></h4>
                  ...
                  <div class="tour-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/tour-2.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                              <h4><router-link to="/">Hawa Mahal </router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
                  ...
                  <div class="tour-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/tour-3.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                              <h4><router-link to="/">Sariska Tiger  </router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
                  ...
                  <div class="tour-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/tour-4.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                  ...
                  <div class="tour-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/tour-5.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                  ...
                  <div class="tour-block-one col-xl-4 col-lg-6 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/tour-6.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
