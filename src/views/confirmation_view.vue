          ...
          <div class="prod-box">
              <div class="prod-block">
                  <div class="prod-inner">
                      ...
                      <div class="prod-title"><router-link to="/">Group members</router-link></div>
  ...
  <section class="wishlist-section">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h3 class="card-title">Booking Reference: XYZ12345</h3>
        </div>
        <div class="card-body">
            <p>Thank you for choosing Cathay Pacific. We are excited to have you on board!</p>
            
            <!-- Flight Details -->
            <section>
                <h5>Flight Details</h5>
                <p><strong>Departure:</strong> Hong Kong, 18:00 23th of July 2023</p>
                <p><strong>Arrival:</strong> Los Angeles, 17:00 23th of July 2023</p>
                <p><strong>Flight Number:</strong> XYZ 456</p>
                <p><strong>Class:</strong> Business</p>
            </section>

            <!-- Group Booking Info -->
            <section>
                <h5>Group Booking Information</h5>
                <p><strong>Number of Passengers:</strong> 5</p>
                <p><strong>Group Leader:</strong> MUZURAIMOV Baiel</p>
                <p><strong>Total Fare:</strong> $0</p>
            </section>

            <!-- Carbon Footprint Savings -->
            <section class="mt-4">
                <h5>🌱 Your Contribution to a Greener Planet 🌱</h5>
                <p><strong>Estimated CO₂ Emissions:</strong> 10240 kg CO₂</p>
                <p><strong>CO₂ Saved:</strong> 290 kg CO₂</p>
                <p>This saving is equivalent to the carbon sequestered by 60 tree seedlings grown for 10 years...</p>
            </section>

            <!-- Asia Miles Earned -->
            <section class="mt-4">
                <h5>🌏 Earn Asia Miles 🌏</h5>
                <p><strong>Miles per Passenger:</strong> 10,000 Miles</p>
                <p><strong>Total Miles for Group:</strong> 100,0000 Miles</p>
                <p>These miles can be redeemed for exciting rewards...</p>
            </section>

            <!-- Preparation for Journey -->
            <section class="mt-4 mb-3">
                <h5>Preparing for Your Journey</h5>
                <ul>
                    <li>Online check-in opens 48 hours before departure.</li>
                    <li>Baggage Information: 32KG</li>
                    <li>Ensure all passengers have valid IDs and travel documents.</li>
                </ul>
            </section>
        </div>
    </div>
              ...
              <div class="table-outer">
                          ...
                          <tbody>
                              <tr>
                                  <td class="prod-column image-column">
                                      <div class="image-box">
                                          <figure class="prod-thumb"><router-link to="/"><img src="@/assets/images/resource/shop/s-cart-thumb.jpg" alt=""></router-link></figure>
                                      </div>
                                  </td>
                                  <td class="prod-column info-column">
                                      <div class="info-box">
                                          <h4 class="prod-title">Group members</h4>
                                          <div class="price">Locked price <span>$225.00</span></div>
                                          <div class="date">Expires on the 23:59 25th of November</div>
                                      </div>
                                  </td>
                                  <td class="avail">
                                      <div class="add-btn"><router-link to="/" class="theme-btn add-cart-btn"><span>Share the link</span></router-link></div>
                                  </td>
                              </tr>
                          </tbody>
                      </table>
                  ...
                  <div class="wishlist-lower clearfix">
                      <div class="left clearfix">
                          <div class="link-title">Share my TravelSpace</div>
                          <div class="link-form clearfix">
                              <div class="field">
                                  <input type="text" name="coupon-code" value="" placeholder="https://travelsync.com/travelspace">
                              </div>
                              <div class="button">
                                  <button type="button" @click="navigateNext" class="theme-btn btn-style-two"><span>Go to my TravelSpace</span></button>
                              </div>
                          </div>
                      </div>
                      <div class="share clearfix">
                          ...
                          <ul class="share-links clearfix">
                              <li><router-link to="/"><span class="fab fa-facebook-f"></span></router-link></li>
                              <li><router-link to="/"><span class="fab fa-twitter"></span></router-link></li>
                              <li><router-link to="/"><span class="fab fa-youtube"></span></router-link></li>
                              <li><router-link to="/"><span class="fab fa-instagram"></span></router-link></li>
                          </ul>
                      </div>
                  </div>
