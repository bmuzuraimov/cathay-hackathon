<template>
  ...
  <section class="products-section products-page">
      ...
      <div class="floated-icon right-2"><img src="@/assets/images/resource/plant-icon.svg" alt="" title=""></div>
      <div class="auto-container">

          <div class="title-box centered">
              <h2><span>Featured TravelSync Products</span></h2>
          ...
          <div class="filters-row clearfix">
              <div class="cat-links">
                  <ul class="clearfix">
                      <li><router-link to="/" class="active">All</router-link></li>
                      <li><router-link to="/">Business</router-link></li>
                      <li><router-link to="/">Life Style</router-link></li>
                      <li><router-link to="/">Music</router-link></li>
                      <li><router-link to="/">Technology</router-link></li>
                      <li><router-link to="/">Clothing</router-link></li>
              ...
              <div class="sort-by">
                  <div class="drop-list-one">
                      <div class="inner clearfix">
                          <div class="dropdown-outer open"><router-link class="btn-box dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" to="/">Default sorting</router-link>
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                  <li><router-link to="/">Default: Latest First</router-link></li>
                                  <li><router-link to="/">Price: High to Low</router-link></li>
                                  <li><router-link to="/">Date: Ascending</router-link></li>
                                  <li><router-link to="/">Date: Descending</router-link></li>
                              </ul>
                          </div>
                      </div>
                  </div>
          ...
          <div class="see-more-link"><router-link to="/" class="theme-btn btn-style-one"><span>Load More......</span></router-link></div>
      </div>
  </section>
