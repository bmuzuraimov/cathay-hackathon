<template>
  ...
  <section class="page-info">
      <div class="auto-container">
          <div class="links">
              <router-link to="/">Home</router-link> &ensp;<i class="fa fa-caret-right"></i>&ensp; <router-link to="destinations">Destination</router-link> &ensp;<i class="fa fa-caret-right"></i> &ensp;<router-link to="destinations">Rajasthan</router-link> &ensp;<i class="fa fa-caret-right"></i>&ensp; <span class="current">Discover Rajasthan</span>
          </div>
      </div>
  </section>

  <!-- Banner Section -->
  <section class="packages-banner style-two" style="background-image: url(images/background/banner-3.jpg);"></section>
  <!--End Banner Section -->
