<template>
  ...
  <section class="page-info">
      <div class="auto-container">
          <div class="links">
              <router-link to="/">Home</router-link> &ensp;<i class="fa fa-caret-right"></i>&ensp; <router-link to="trekking">Trekking</router-link> &ensp;<i class="fa fa-caret-right"></i>&ensp; <span class="current">Trekking Details</span>
          </div>
      </div>
  </section>

  <!-- Banner Section -->
  <section class="packages-banner" style="background-image: url(images/background/banner-2.jpg);">
      <div class="auto-container">
          <ul class="banner-list">
              <li><span class="icon"><img src="@/assets/images/icons/location.svg" alt="" /></span>Moscow, Russia</li>
              <li>View on Map</li>
          </ul>
      </div>
  </section>
  ...
  <section class="package-detail-section">
      <div class="auto-container">
          ...
          <div class="upper-box">
              <div class="clearfix">
                  <div class="pull-left">
                      <h4>Moscow Cable Car Sky Pass</h4>
                  </div>
          ...
          <div class="package-info-box-two">
              <div class="inner-container d-flex justify-content-between align-items-center">
                  ...
                  <div class="package-info-block-two">
                      <div class="inner-box">
                          <div class="icon"><img src="@/assets/images/icons/banned.svg" alt="" /></div>
                          No Cancelation
                      </div>
                  </div>
                  ...
                  <div class="package-info-block-two">
                      <div class="inner-box">
                          <div class="icon"><img src="@/assets/images/icons/printer.svg" alt="" /></div>
                  ...
                  <div class="package-info-block-two">
                      <div class="inner-box">
                          <div class="icon"><img src="@/assets/images/icons/queue.svg" alt="" /></div>
                          30 Minits Duration
                      </div>
                  </div>
                  ...
                  <div class="package-info-block-two">
                      <div class="inner-box">
                          <div class="icon"><img src="@/assets/images/icons/ticket.svg" alt="" /></div>
              ...
              <div class="content-column col-xl-8 col-lg-7 col-md-12 col-sm-12">
                  ...
                  <div class="facility-box">
                      ...
                      <div class="row clearfix">
                          <div class="column col-lg-4 col-md-4 col-sm-12">
                              <div class="facility-option"><span class="icon"><img src="@/assets/images/icons/campings.svg" alt="" /></span> Camping Tents</div>
                          </div>
                          <div class="column col-lg-4 col-md-4 col-sm-12">
                              <div class="facility-option"><span class="icon"><img src="@/assets/images/icons/toilet.svg" alt="" /></span> Portable Toilet</div>
                          </div>
                          <div class="column col-lg-4 col-md-4 col-sm-12">
                              <div class="facility-option"><span class="icon"><img src="@/assets/images/icons/kitchen-tool.svg" alt="" /></span> Cooking Equipment</div>
                          </div>
                          <div class="column col-lg-4 col-md-4 col-sm-12">
                              <div class="facility-option"><span class="icon"><img src="@/assets/images/icons/lights.svg" alt="" /></span> Electric Tent Lights</div>
                          </div>
                          <div class="column col-lg-4 col-md-4 col-sm-12">
                              <div class="facility-option"><span class="icon"><img src="@/assets/images/icons/smoking.svg" alt="" /></span> Smoking Allowed</div>
                          </div>
                          <div class="column col-lg-4 col-md-4 col-sm-12">
                              <div class="facility-option"><span class="icon"><img src="@/assets/images/icons/wifi-signal.svg" alt="" /></span> Wireless Internet</div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="gallery-box">
                      ...
                      <div class="single-item-carousel owl-carousel owl-theme">
                          <div class="slide">
                              <div class="image">
                                  <img src="@/assets/images/resource/gallery.jpg" alt="" />
                              </div>
                          </div>
                          <div class="slide">
                              <div class="image">
                  ...
                  <div class="inner-column">
                      ...
                      <div class="sidebar-widget buy-treker-widget">
                          <div class="widget-content" style="background-image: url(images/background/buy.jpg)">
                              <div class="logo">
                                  <router-link to="/"><img src="@/assets/images/icons/buy-treker.svg" alt="" /></router-link>
                              </div>
  ...
  <section class="news-section-two">
      ...
      <div class="floated-icon right"><img src="@/assets/images/background/pattern-2.png" alt="" title=""></div>
          ...
          <div class="content-box">
              ...
              <div class="popular-carousel owl-theme owl-carousel">
                  ...
                  <div class="activity-block-one">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/activity-4.jpg" alt="" title=""></router-link></div>
                              <div class="price"><span>$120</span></div>
                              <div class="info"><div><span class="icon"><img src="@/assets/images/icons/location-1.svg" alt="" title=""></span> Moscow, Russia</div></div>
                          </div>
                          <div class="lower-content">
                              <h4><router-link to="/">Hill River Rafting top in Ladakh</router-link></h4>
                              ...
                              <div class="bottom-box clearfix">
                                  ...
                                  <div class="fav-link"><router-link to="/" class="theme-btn"><i class="icon far fa-heart"></i></router-link></div>
                              </div>
                          </div>
                  ...
                  <div class="activity-block-one">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/activity-5.jpg" alt="" title=""></router-link></div>
                              <div class="price"><span>$120</span></div>
                              <div class="info"><div><span class="icon"><img src="@/assets/images/icons/location-1.svg" alt="" title=""></span> Moscow, Russia</div></div>
                          </div>
                          <div class="lower-content">
                              <h4><router-link to="/">Moscow Cable Car Sky Pass </router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
                  ...
                  <div class="activity-block-one">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/activity-6.jpg" alt="" title=""></router-link></div>
                              <div class="price"><span>$120</span></div>
                              <div class="info"><div><span class="icon"><img src="@/assets/images/icons/location-1.svg" alt="" title=""></span> Moscow, Russia</div></div>
                          </div>
                          <div class="lower-content">
