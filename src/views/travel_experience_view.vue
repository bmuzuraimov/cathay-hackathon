<template>
  ...
  <section class="page-info">
      <div class="auto-container">
          <div class="links">
              <router-link to="/">Home</router-link> &ensp;<i class="fa fa-caret-right"></i>&ensp; <router-link to="destinations">Destination</router-link> &ensp;<i class="fa fa-caret-right"></i> &ensp;<router-link to="destinations">Kyrgyzstan</router-link> &ensp;<i class="fa fa-caret-right"></i>&ensp; <span class="current">Discover Kyrgyzstan</span>
          </div>
      </div>
  </section>

  <!-- Banner Section -->
  <section class="packages-banner style-two" style="background-image: url(/assets/images/background/banner-3.jpg);"></section>
  <!--End Banner Section -->
          ...
          <div class="row clearfix">
              ...
              <div class="content-column col-xl-8 col-lg-7 col-md-12 col-sm-12">
                  ...
                  <div class="package-info-box style-two">
                      <div class="inner-container d-flex justify-content-between align-items-center">
                          ...
                          <div class="package-info-block">
                              <div class="inner-box">
                                  <div class="icon"><img src="@/assets/images/icons/category-icon.svg" alt="" /></div>
                      ...
                      <div class="row clearfix">
                          <div class="column col-lg-3 col-md-4 col-sm-12">
                              ...
                              <div class="facility-box-two">
                                  <span class="icon">
                                      <img src="@/assets/images/icons/tour-guide.svg" alt="" />
                                  </span>
                                  Tour Operator
                              </div>
                          </div>
                          <div class="column col-lg-3 col-md-4 col-sm-12">
                              ...
                              <div class="facility-box-two">
                                  <span class="icon">
                                      <img src="@/assets/images/icons/bill.svg" alt="" />
                                  </span>
                                  Online Ticketing
                              </div>
                          </div>
                          <div class="column col-lg-3 col-md-4 col-sm-12">
                              ...
                              <div class="facility-box-two">
                                  <span class="icon">
                                      <img src="@/assets/images/icons/passport.svg" alt="" />
                                  </span>
                                  Passport & Visa
                              </div>
                          </div>
                          <div class="column col-lg-3 col-md-4 col-sm-12">
                              ...
                              <div class="facility-box-two">
                                  <span class="icon">
                                      <img src="@/assets/images/icons/travel-insurance.svg" alt="" />
                                  </span>
                                  Travel Insurance
                              </div>
                          </div>
                          <div class="column col-lg-3 col-md-4 col-sm-12">
                              ...
                              <div class="facility-box-two">
                                  <span class="icon">
                                      <img src="@/assets/images/icons/ship.svg" alt="" />
                                  </span>
                                  Cruise Services
                              </div>
                          </div>
                                                          ...
                                                          <div class="inner-content">
                                                              ...
                                                              <div class="hotel-info">
                                                                  <div class="hotel-image">
                                                                      <img src="@/assets/images/resource/hotel.jpg" alt="" />
                                                                  </div>
                                      ...
                                      <div class="content">
                                          ...
                                          <div class="faq-info-tabs">
                                              ...
                                              <div class="faq-tabs tabs-box">
                                                  ...
                                                  <!-- Tab Btns -->
                                                  <ul class="tab-btns tab-buttons clearfix">
                                                      <li data-tab="#prod-10" class="tab-btn active-btn">Accomodation</li>
              ...
              <div class="sidebar-column col-xl-4 col-lg-5 col-md-12 col-sm-12">
                  <div class="inner-column">
                      ...
                      <!-- Booking Widget -->
                      <div class="sidebar-widget booking-widget" style="background-image: url(/assets/images/background/booking-bg.jpg);">
                          <h5>Book this Group Bookings</h5>
  ...
  <section class="news-section-two tours-page">
      ...
      <div class="auto-container">
          <div class="title-box centered">
              <h2><span>Discover More Kyrgyzstan Tours</span></h2>
          </div>
          <div class="content-box">
              ...
              <div class="popular-carousel owl-theme owl-carousel">
                  ...
                  <div class="activity-block-two">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/activity-7.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                              <h4><router-link to="/">Nahargarh Fort</router-link></h4>
                  ...
                  <div class="activity-block-two">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/activity-8.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                              <h4><router-link to="/">Jal Mahal</router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
                  ...
                  <div class="activity-block-two">
                      <div class="inner-box">
                          <div class="image-box">
                              <div class="image"><router-link to="/"><img src="@/assets/images/resource/activity-9.jpg" alt="" title=""></router-link></div>
                          </div>
                          <div class="lower-content">
                              <div class="price"><span>$120</span></div>
                              <h4><router-link to="/">Chittorgarh</router-link></h4>
                              <div class="ratings clearfix">
                                  <div class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star empty"></i></div>
                                  <div class="rev"><router-link to="/">05 Review</router-link></div>
                              </div>
