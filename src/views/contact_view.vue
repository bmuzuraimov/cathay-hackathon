<template>
                      ...
                      <div class="nav-outer clearfix">         
                          <nav class="main-menu">
                              <ul class="navigation clearfix">
                                  ...
                                  <li class="current"><router-link to="contact">Contact</router-link></li>
                              </ul>
                          </nav>
                          <!-- Main Menu End-->
                      </div>
  ...
  <section class="contact-section">
      <div class="floated-icon right"><img src="@/assets/images/resource/stones-right-3.svg" alt="" title=""></div>
      <div class="floated-icon right-2"><img src="@/assets/images/resource/stones-right-2.svg" alt="" title=""></div>
      <div class="auto-container">
          ...
          <div class="info-section">
              <div class="row clearfix">
                  ...
                  <div class="info-block col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="map-icon"><img src="@/assets/images/resource/europe-map.svg" alt="" title=""></div>
                          <h5>Europe</h5>
                          <div class="address text">Europe 45 Gloucester Road <br>London T1M 3BF</div>
                          <div class="phone"><router-link to="tel:+4402036715709">+852 2747 3333</router-link></div>
                      </div>
                  </div>
                  <!--Block-->
                  <div class="info-block col-lg-4 col-md-6 col-sm-12">
                      <div class="inner-box">
                          <div class="map-icon"><img src="@/assets/images/resource/asia-map.svg" alt="" title=""></div>
                          <h5>Asia & Pacific</h5>
                          <div class="address text">2473 Red Road Ste 98 <br>Singapore SG</div>
                          <div class="phone"><router-link to="tel:+16232116319">+ 1 623 211 6319</router-link></div>
                      </div>
                  </div>
                  <!--Block-->
                  <div class="info-block col-lg-4 col-md-12 col-sm-12">
                      <div class="inner-box">
                          <div class="map-icon"><img src="@/assets/images/resource/north-america-map.svg" alt="" title=""></div>
                          <h5>North America</h5>
                          <div class="address text">Canada 45 Gloucester Road <br>London T1M 3BF</div>
                          <div class="phone"><router-link to="tel:+45765371319">+ 45 765 371 319</router-link></div>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="row clearfix">
              ...
              <div class="map-col col-lg-6 col-md-12 col-sm-12">
                  <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                      <div class="map">
                          <div class="map-image"><img src="@/assets/images/resource/world-map.svg" alt="" title=""></div>
                          <div class="loc-point loc-1">
                              <div class="loc-icon"><img src="@/assets/images/icons/loc-hover.svg" alt="" title=""></div>
                              <div class="loc-popup">
                                  <div class="text">Canada 45 Gloucester Road London T1M 3BF</div>
                                  <div class="link"><router-link to="/">View on Map</router-link></div>
                              </div>
                          </div>
                      ...
                      <div class="accordion-box clearfix">
                          ...
                          <div class="accordion block active-block">
                              ...
                              <div class="acc-content">
                                  <div class="content">
                                      <div class="text">One of the major benefits of travelsyncking is that it improves your physical health immensely. Spending multiple hours on the trail, climbing around boulders.</div>
                                  </div>
                              </div>
                          </div>
                          <!--Block-->
